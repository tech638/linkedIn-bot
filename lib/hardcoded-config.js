...
module.exports = {
  ...
  // Fixed group (optional) — sheet skipped only when TEST_MODE + FIXED_GROUP_URL
  FIXED_GROUP_URL: "",
  FIXED_GROUP_NAME: "",
  ...
  CHROME_PATH: localChromePath(),
  CHROME_BOT_DATA_DIR: localBotDataDir(),
  ...
  POST_LANDING_URL: "https://go.behindthecurtain.ai/top10",
  ...
  // ─── Post / group UI ────────────────────────────────────────────
  POST_EMBER_IDS: "ember94,ember95,ember131,ember276",
  COMPOSER_OPENER_SELECTOR: "#ember95||#ember96||.groups-share-box #ember95",
  ...
  POST_EDITOR_WAIT_MS: "3500",
  POST_AFTER_TYPE_WAIT_MS: "3000",
  POST_SUBMIT_WAIT_MS: "2000",
  GROUP_PAGE_LOAD_MS: "15000",
  GROUP_FEED_WAIT_MS: "12000",
  GROUP_COMPOSER_SCROLL_WAIT_MS: "1200",
  PAGE_TIMEOUT_MS: "60000",
  POST_CLICK_TIMEOUT_MS: "12000",
  POST_EDITOR_SELECTOR:
    "[id^='ember'] > div > div.share-creation-state.share-creation-state__share-box-v2.share-creation-state__share-box-v2--redesigned-detours > div.share-creation-state__content-scrollable > div > div > div > div > div > div > div.ql-editor.ql-blank||#ember95 div.ql-editor[contenteditable='true']||#ember131 > div > div.share-creation-state.share-creation-state__share-box-v2.share-creation-state__share-box-v2--redesigned-detours > div.share-creation-state__content-scrollable > div > div > div > div > div > div > div.ql-editor.ql-blank > p",
  POST_SUBMIT_SELECTOR:
    "[id^='ember'] div.share-creation-state__footer button.share-actions__primary-action||[id^='ember'] div.share-creation-state__footer button||#ember95 div.share-creation-state__footer button",
